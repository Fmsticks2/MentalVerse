...
#[ic_cdk_macros::query(name = "get_balance")]
#[candid::candid_method(query, rename = "get_balance")]
async fn _cdk_user_defined_get_balance(_cdk_user_defined_user: String) -> (candid::Int) {
    let interpreter = unsafe { INTERPRETER_OPTION.as_mut() }
        .unwrap_or_trap("SystemError: missing python interpreter");
    let vm = &interpreter.vm;
    let params = (_cdk_user_defined_user
        .try_into_vm_value(vm)
        .unwrap_or_trap(),);
    call_global_python_function("get_balance", params)
        .await
        .unwrap_or_trap()
}
#[ic_cdk_macros::update(name = "create_token")]
#[candid::candid_method(update, rename = "create_token")]
async fn _cdk_user_defined_create_token(
    ...
    call_global_python_function("create_token", params)
        .await
        .unwrap_or_trap()
}
#[derive(
